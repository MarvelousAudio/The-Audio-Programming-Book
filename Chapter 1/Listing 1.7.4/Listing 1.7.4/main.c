...
//input: points = array of BREAKPOINTS, npoint gives the lenghth of the array

//output: copyt of the BREAKPOINT containing largest value
...
BREAKPOINT* get_breakpoints(FILE* fp, long* psize)
{
    ...
    if (points == NULL)
        ...
        while (fgets(line, 80, fp))
        {
            ...
            {
                printf("data error at point %ld: time not increaseing\n" , npoints+1);
                break;
            }
