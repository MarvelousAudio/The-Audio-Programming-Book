...
//  
//
//  Created by ben haywood on 7/19/20.
//
...
int main (int argc, char* argv[])
{
    ...
    psf_ormate outformat = PSF_FMT_UNKNOWN;
    ...
    outformat = psf_getFromatExt(argv[ARG_OUTFILE]);
    ...
    frameread = psf_sndReadFloatFrames(ifd, frame, 1);
