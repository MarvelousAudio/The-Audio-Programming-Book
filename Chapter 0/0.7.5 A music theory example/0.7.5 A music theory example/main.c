...
int main(int argc, const char * argv[]) {
    ...
    */
    ...
    /* print the number of semitones. the special case of unison (0)
     has to be handled correctly, os we use the conditional operator for this
     */
    ...
    switch(interval)
    {
        ...
        case 4:
            ...
            break;
        case 5:
            printf("perfect 4th up perfect 5th down\n");
            break;
        case 6:
        ...
        case 9:
            ...
            break;
        case 10:
            printf("minor 7th up major 2nd down\n");
            break;
        case 11:
